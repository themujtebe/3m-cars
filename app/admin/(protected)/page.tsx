      ...
      <div className="rounded-2xl border border-black/[0.06] bg-white p-6 md:p-8  ">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h2 className="mt-1 text-[28px] font-bold text-[#111] " style={{ fontFamily: "var(--font-tajawal)" }}>إدارة الموقع من مكان واحد</h2>
            <p className="mt-2 max-w-lg text-[14px] leading-[1.8] text-[#777] " style={{ fontFamily: "var(--font-tajawal)" }}>تحكم بالسيارات والباقات والصور والإعدادات بسهولة ويسر.</p>
          </div>
          <div className="flex gap-3">
            <Link href="/admin/cars/new" className="flex items-center gap-2 rounded-full bg-[#111] px-6 py-2.5 text-[13px] font-bold text-white transition-colors hover:bg-[#a71225]    " style={{ fontFamily: "var(--font-tajawal)" }}>
              <Plus size={15} />إضافة سيارة
            </Link>
            <Link href="/admin/cars" className="flex items-center gap-2 rounded-full border border-black/[0.10] px-6 py-2.5 text-[13px] font-semibold text-[#555] transition-colors hover:border-black/20   " style={{ fontFamily: "var(--font-tajawal)" }}>
        ...
        <div className="rounded-2xl border border-black/[0.06] bg-white p-6  ">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {quickActions.map((a) => {
              const Icon = a.icon;
              return (
                <Link key={a.title} href={a.href} className="group rounded-xl border border-black/[0.06] bg-[#f7f7f7] p-4 transition-all hover:border-[#a71225]/25 hover:bg-white hover:shadow-sm   ">
        ...
        <div className="rounded-2xl border border-black/[0.06] bg-white p-6  ">
          ...
          {latest.length === 0 ? (
            ...
            <div className="flex flex-col gap-3">
              {latest.map((car) => (
                <Link key={car.id} href={`/admin/cars/${car.id}/edit`} className="flex items-center gap-3 rounded-xl border border-black/[0.06] bg-[#f7f7f7] px-3 py-2.5 transition-colors hover:border-[#a71225]/20 hover:bg-white   ">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="truncate text-[13px] font-semibold text-[#111] " style={{ fontFamily: "var(--font-tajawal)" }}>{car.title_ar}</p>
                    <p className="text-[11px] text-[#999] " style={{ fontFamily: "var(--font-tajawal)" }}>{car.year} · {car.price.toLocaleString("en-US")} {car.currency}</p>
                  </div>
