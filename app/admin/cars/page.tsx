              ...
              <div key={car.id} className="flex items-center gap-4 px-5 py-4 transition-colors hover:bg-[#f7f7f7] dark:hover:bg-[#1c1c1f]">
                ...
                <span className={`shrink-0 rounded-full px-3 py-1 text-[11px] font-bold ${
                  car.status === "available"
                    ...
                    : "bg-red-50 text-[#a71225] border border-red-200 dark:bg-red-950 dark:text-red-400 dark:border-red-800"
                }`} style={{ fontFamily: "var(--font-tajawal)" }}>
                ...
                <div className="flex shrink-0 items-center gap-2">
                  ...
                  <form action={deleteCarAction}>
                    <input type="hidden" name="id" value={car.id} />
                    <button type="submit" className="flex items-center gap-1.5 rounded-lg border border-red-200 bg-red-50 px-3 py-1.5 text-[12px] font-medium text-[#a71225] transition-colors hover:bg-red-100 dark:border-red-800 dark:bg-red-950 dark:text-red-400 dark:hover:bg-red-900" style={{ fontFamily: "var(--font-tajawal)" }}>
