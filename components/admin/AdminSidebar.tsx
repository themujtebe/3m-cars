    ...
    <aside className="hidden w-[260px] shrink-0 border-l border-black/[0.06] bg-white xl:flex xl:flex-col  ">
      <div className="sticky top-0 flex h-screen flex-col">
        ...
        <div className="border-b border-black/[0.06]  px-6 py-5">
          <Link href="/admin" className="flex items-center gap-3">
            ...
            <div className="leading-none">
              <div className="text-[14px] font-bold text-[#111] " style={{ fontFamily: "var(--font-tajawal)" }}>3M CARS</div>
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-4">
          <p className="mb-2 px-3 text-[10px] font-bold tracking-[2px] text-[#bbb]  uppercase" style={{ fontFamily: "var(--font-tajawal)" }}>MENU</p>
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-3 rounded-xl px-3 py-2.5 text-[14px] font-medium transition-all ${
                    active
                      ? "bg-[#a71225]/[0.08] text-[#a71225]  "
                      : "text-[#555] hover:bg-black/[0.04] hover:text-[#111]   "
                  }`}
                  style={{ fontFamily: "var(--font-tajawal)" }}
                >
                  <Icon size={17} className={active ? "text-[#a71225]" : "text-[#999] "} />
                  {link.title}
                </Link>
              );
            })}
