...
export default function Footer() {
  return (
    <footer className="bg-[#f0f0f0]  px-10 pb-10 pt-[60px] border-t border-black/[0.06] ">
      <div className="grid gap-12 md:grid-cols-[1.5fr_1fr_1fr]">
        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            <div className="leading-none">
              <div className="text-[15px] font-bold tracking-wide text-[#111] ">3M CARS</div>
              <div className="text-[10px] font-semibold tracking-[2px] text-[#888] ">3mcars.bh</div>
            </div>
          </div>

          <p className="mt-4 max-w-[260px] text-[13px] leading-[1.8] text-[#666] " style={{ fontFamily: "var(--font-tajawal)" }}>
        ...
        {/* Col 2 — Quick links */}
        <div>
          <h4 className="mb-5 text-[10px] font-bold tracking-[3px] text-[#999]  uppercase" style={{ fontFamily: "var(--font-tajawal)" }}>
            روابط سريعة
          </h4>
      ...
      <div className="mt-12 flex flex-col items-center justify-between gap-2 border-t border-black/[0.08]  pt-6 sm:flex-row">
        ...
        <div className="flex gap-4 text-[12px] text-[#aaa] " style={{ fontFamily: "var(--font-tajawal)" }}>
          <Link href="#" className="transition-colors hover:text-[#555] ">سياسة الخصوصية</Link>
          <span>|</span>
          <Link href="#" className="transition-colors hover:text-[#555] ">الشروط والأحكام</Link>
        </div>
      </div>
    </footer>
  );
