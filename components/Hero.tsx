  ...
  return (
    <section className=" relative min-h-[calc(100vh-72px)] overflow-hidden bg-white ">
      ...
      <div className="relative z-10 flex min-h-[calc(100vh-72px)] flex-col justify-center px-10 pb-16 pt-16 max-w-[1400px] mx-auto">
        ...
        <p className="mt-8 max-w-[480px] leading-[1.7] text-[#555] " style={{ fontFamily: "var(--font-tajawal)", fontSize: "16px" }}>
        ...
        <div className="absolute bottom-10 left-10 flex flex-col gap-1">
          <p className="text-[10px] font-bold tracking-[2px] text-[#999] " style={{ fontFamily: "var(--font-tajawal)" }}>تأسست في البحرين</p>
          <p className="text-[10px] font-bold tracking-[2px] text-[#999] " style={{ fontFamily: "var(--font-tajawal)" }}>شبكة عالمية</p>
        </div>
      </div>
    </section>
  );
