      ...
      <div className="mx-auto flex h-full max-w-[1400px] items-center justify-between px-5 sm:px-10">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <Link
            href="/admin"
            prefetch={false}
            className="hidden items-center text-[#111] transition-colors hover:text-[#a71225]   sm:flex"
            aria-label="البوابة"
          >
        ...
        <div className="absolute inset-x-0 top-full border-b border-black/[0.07] bg-white shadow-lg   md:hidden">
          <nav className="flex flex-col gap-0.5 px-4 py-3" style={{ fontFamily: "var(--font-tajawal)" }}>
            ...
            <Link
              ...
              prefetch={false}
              onClick={() => setMenuOpen(false)}
              className="flex items-center gap-2 rounded-xl px-4 py-3.5 text-[15px] font-semibold text-[#666] "
            >
              <User className="h-4 w-4" />
              البوابة
            </Link>
